...
With dynamic mode, the bank ID is composed from granularity fields (default: `agent::project`). A project at `/home/username/my-app` gets bank ID `opencode::my-app`.
