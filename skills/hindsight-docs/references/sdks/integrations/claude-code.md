...
By default, all git worktrees of the same repository share one bank. For example, if you keep a main checkout at `/home/username/myproject` and a worktree at `/home/username/myproject-wt1`, both resolve to `project = "myproject"` — so dynamic bank IDs like `claude-code::myproject` are stable across all worktrees. This avoids fragmenting memory across short-lived branches.
...
{
  "directoryBankMap": {
    "/home/username/work/client-a": "client-a-memories",
    "/home/username/personal/blog": "blog"
  }
}
```
