"""Shared fixtures for Hindsight OMO plugin tests."""
...
def default_config(plugin_root, monkeypatch):
    """Load config with no overrides, isolated from real settings."""
...
def make_transcript_file(tmp_path, messages):
    """Write messages as a JSONL transcript file (flat format)."""
