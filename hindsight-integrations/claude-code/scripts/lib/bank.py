...
def _resolve_project_name(cwd: str, config: dict) -> str:
    ...
    For a regular repo at /home/username/myproject:
        git-common-dir → /home/username/myproject/.git → basename "myproject"

    For a worktree at /home/username/myproject-wt1 linked to /home/username/myproject:
        git-common-dir → /home/username/myproject/.git → basename "myproject"
    """
    if not cwd:
        return "unknown"
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            # e.g. /home/username/myproject/.git → parent is /home/username/myproject
