...
def make_hook_input(
    ...
    **extras,
    ...
    payload = {
        ...
        "workspace_roots": workspace_roots or ["/home/username/myproject"],
...
def make_stop_input(response_text="world", session_id="sess-abc123", cwd="/home/username/myproject", **extras):
    ...
    payload = {
        ...
        "cwd": cwd,
        "workspace_roots": ["/home/username/myproject"],
        "toolCallCount": 0,
        "hookEventName": "Stop",
    }
    payload.update(extras)
